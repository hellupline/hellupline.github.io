...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6cc576c8635a279dbd04454661467fd489cf92accc0c913d36258c18766cd913.js',function(){input.required=false;search();});}

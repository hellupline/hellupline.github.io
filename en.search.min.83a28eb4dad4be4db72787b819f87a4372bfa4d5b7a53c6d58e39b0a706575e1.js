...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.547506e4689d22d8bc564f85c4a1081ddac2a9541c6be2cdf1d8ec742164cd03.js',function(){input.required=false;search();});}

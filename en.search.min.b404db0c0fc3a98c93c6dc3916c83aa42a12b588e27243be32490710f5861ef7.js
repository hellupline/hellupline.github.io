...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f1b94ac531238a432e45b3bf8bd4a1d5630e22261a81aa2b7dbde334a8215fd5.js',function(){input.required=false;search();});}

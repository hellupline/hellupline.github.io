...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dfd2881a3c0d0af58d10c75a0fc99ea7b5bfd8d046d9432641aad75f9934209e.js',function(){input.required=false;search();});}

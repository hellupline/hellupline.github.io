...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.76d45328925c74be85cc76f38c4292b89607bbf5856c4e2f8062b8e59db49fb5.js',function(){input.required=false;search();});}

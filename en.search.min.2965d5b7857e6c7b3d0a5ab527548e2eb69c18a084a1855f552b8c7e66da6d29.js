...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.75716838c97b64029a24c6504cbf8048d2be6393d28a85e2e8754bcf9108f938.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cef85c97517371ae8b3a85cae738316147871101bf89b52cd4d4489c5703542a.js',function(){input.required=false;search();});}
